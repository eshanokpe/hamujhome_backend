        ...
        <div class="row gx-xxl-5">
            ...
            <div class="col-lg-6">
                <div class="details-text ps-xxl-5 md-mt-40">
                    ...
                    <h3>Birch -  Sleek Sofa</h3>
                    <div class="d-flex justify-content-between align-items-center">
                            <span class="price"><h4>₦798,450</h4></span>
                        </div>
                    <p class="fs-24 pt-45 xl-pt-30 pb-45 xl-pb-30">
                        Birch, a chic 2-seater with a sleek backrest in eggnog hue, seamlessly combines comfort and style for your minimalist space.
                     </p>
